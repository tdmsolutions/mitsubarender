...
namespace MitsubaRender.RenderSettings
{
	...
	public class IntegratorPathTracer : ISave
	{
		...
		public int RussianRouletteStartingDepth
		{
			get;
			set;
		}
	...
	public class IntegratorPhotonMapper : ISave
	{
		...
		public int CausticPhotonMapLookupSize
		{
			get;
			set;
		}
	...
	public class IntegratorEnergyRedisributionPathTracing : ISave
	{
		...
		public float AverageNumberOfChains
		{
			get;
			set;
		}
	...
	public class IntegratorAdaptativeIntegrator : ISave
	{
		...
		public int MaximumSampleFactor
		{
			get;
			set;
		}
	...
	public class IntegratorIrradianceCaching : ISave
	{
		...
		public float QualityAdjustment
		{
			get;
			set;
		}
